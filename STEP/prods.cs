...
public abstract class PLoopContBreak : Node
{
}
...
public abstract class PIncreaseDecrease : Node
{
}
...
public sealed class ANoelseLoopifstmt : PLoopifstmt
{
    ...
    private PCond _cond_;
    private TRparen _rparen_;
    private TypedList _loop_cont_break_;
    private TEndif _endif_;

    public ANoelseLoopifstmt ()
    {
        this._loop_cont_break_ = new TypedList(new LoopContBreak_Cast(this));
    }
    ...
    )
    {
        ...
        SetRparen (_rparen_);
        this._loop_cont_break_ = new TypedList(new LoopContBreak_Cast(this));
        this._loop_cont_break_.Clear();
        this._loop_cont_break_.AddAll(_loop_cont_break_);
        SetEndif (_endif_);
    }
    ...
    public IList GetLoopContBreak ()
    {
        return _loop_cont_break_;
    }

    public void setLoopContBreak (IList list)
    {
        _loop_cont_break_.Clear();
        _loop_cont_break_.AddAll(list);
    }
    public TEndif GetEndif ()
    {
        return _endif_;
    ...
    internal override void RemoveChild(Node child)
    {
        ...
        if ( _loop_cont_break_.Contains(child) )
        {
            _loop_cont_break_.Remove(child);
            return;
        }
        if ( _endif_ == child )
        {
    ...
    internal override void ReplaceChild(Node oldChild, Node newChild)
    {
        ...
        for ( int i = 0; i < _loop_cont_break_.Count; i++ )
        {
            Node n = (Node)_loop_cont_break_[i];
            if(n == oldChild)
            {
                if(newChild != null)
                {
                    _loop_cont_break_[i] = newChild;
                    oldChild.Parent(null);
                    return;
                }

                _loop_cont_break_.RemoveAt(i);
                oldChild.Parent(null);
                return;
            }
        }
    ...
    private class LoopContBreak_Cast : Cast
    {
        ANoelseLoopifstmt obj;

        internal LoopContBreak_Cast (ANoelseLoopifstmt obj)
        {
          this.obj = obj;
        }
        ...
        public Object Cast(Object o)
        {
            PLoopContBreak node = (PLoopContBreak) o;
...
public sealed class AOneLoopContBreak : PLoopContBreak
{
    private PLoopStmt _loop_stmt_;

    public AOneLoopContBreak ()
    {
    }
    ...
    public override void Apply(Switch sw)
    {
        ((Analysis) sw).CaseAOneLoopContBreak(this);
    }
...
public sealed class ATwoLoopContBreak : PLoopContBreak
{
    private TContinue _continue_;
    private TNl _nl_;

    public ATwoLoopContBreak ()
    {
    }
    ...
    public override void Apply(Switch sw)
    {
        ((Analysis) sw).CaseATwoLoopContBreak(this);
    }
...
public sealed class AThreeLoopContBreak : PLoopContBreak
{
    private TBreak _break_;
    private TNl _nl_;

    public AThreeLoopContBreak ()
    {
    }
    ...
    public override Object Clone()
    {
        return new AThreeLoopContBreak (
    ...
    public override void Apply(Switch sw)
    {
        ((Analysis) sw).CaseAThreeLoopContBreak(this);
    }
...
public sealed class AForstmt : PForstmt
{
    ...
    private PExpr _fst_;
    private TComma _comma_;
    private PIncreaseDecrease _increase_decrease_;
    private PExpr _snd_;
    private TRparen _rparen_;
    private TypedList _loop_stmt_;
    ...
    public AForstmt (
            ...
            PExpr _fst_,
            TComma _comma_,
            PIncreaseDecrease _increase_decrease_,
            PExpr _snd_,
            TRparen _rparen_,
            IList _loop_stmt_,
            TEndfor _endfor_
    )
    {
        ...
        SetFst (_fst_);
        SetComma (_comma_);
        SetIncreaseDecrease (_increase_decrease_);
        SetSnd (_snd_);
        SetRparen (_rparen_);
        this._loop_stmt_ = new TypedList(new LoopStmt_Cast(this));
        this._loop_stmt_.Clear();
    ...
    public override Object Clone()
    {
        return new AForstmt (
            ...
            (TComma)CloneNode (_comma_),
            (PIncreaseDecrease)CloneNode (_increase_decrease_),
    ...
    public PIncreaseDecrease GetIncreaseDecrease ()
    {
        return _increase_decrease_;
    }

    public void SetIncreaseDecrease (PIncreaseDecrease node)
    {
        if(_increase_decrease_ != null)
        {
            _increase_decrease_.Parent(null);
        }
    ...
    internal override void RemoveChild(Node child)
    {
        ...
        if ( _increase_decrease_ == child )
        {
            _increase_decrease_ = null;
            return;
        }
        if ( _snd_ == child )
        {
    ...
    internal override void ReplaceChild(Node oldChild, Node newChild)
    {
        ...
        if ( _increase_decrease_ == oldChild )
        {
            SetIncreaseDecrease ((PIncreaseDecrease) newChild);
            return;
        }
        if ( _snd_ == oldChild )
        {
...
public sealed class AOneIncreaseDecrease : PIncreaseDecrease
{
    private TIncreaseby _increaseby_;

    public AOneIncreaseDecrease ()
    {
    }
    ...
    public override Object Clone()
    {
        return new AOneIncreaseDecrease (
    ...
    public override void Apply(Switch sw)
    {
        ((Analysis) sw).CaseAOneIncreaseDecrease(this);
    }
...
public sealed class ATwoIncreaseDecrease : PIncreaseDecrease
{
    private TDecreaseby _decreaseby_;

    public ATwoIncreaseDecrease ()
    {
    }
    ...
    public override Object Clone()
    {
        return new ATwoIncreaseDecrease (
    ...
    public override void Apply(Switch sw)
    {
        ((Analysis) sw).CaseATwoIncreaseDecrease(this);
    }
