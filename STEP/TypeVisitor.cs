...
public class TypeVisitor : IVisitor {
    ...
    public void Visit(AndNode n) {
        ...
        if (n.Left.Type == expectedType && n.Right.Type == expectedType) {
            ...
            throw new TypeException(n, TypeVal.Boolean, n.Left.Type.ActualType, n.Right.Type.ActualType);
        }
    }
    ...
    public void Visit(EqNode n) {
        ...
        if (n.Left.Type == n.Right.Type && !n.Left.Type.IsArray) {
            ...
            n.Type.ActualType = TypeVal.Error;
            throw new TypeException(n, n.Left.Type.ActualType, n.Right.Type.ActualType);
        }
    }
    ...
    public void Visit(GThanNode n) {
        ...
        if (n.Left.Type == expectedType && n.Right.Type == expectedType) {
            ...
            n.Type.ActualType = TypeVal.Error;
            throw new TypeException(n, TypeVal.Number, n.Left.Type.ActualType, n.Right.Type.ActualType);
        }
    }
    ...
    public void Visit(NegNode n) {
        ...
        if (n.Left.Type == expectedType) {
            ...
            n.Type.ActualType = TypeVal.Error;
            throw new TypeException(n, TypeVal.Boolean, n.Left.Type.ActualType);
        }
    }
    ...
    public void Visit(ArrLiteralNode n) {
        ...
        if (n.Elements.First() is null) return;
        n.Elements.First().Accept(this);
        var firstType = n.Elements.First().Type;
        foreach (var expr in n.Elements.Skip(1)) {
            expr.Accept(this);
            if (expr.Type == firstType) continue;
            n.Type.ActualType = TypeVal.Error;
            throw new TypeException(n, firstType!.ActualType, expr.Type.ActualType); // Type will never be null here
        }
    ...
    public void Visit(ArrayAccessNode n) {
        ...
        if (n.Index.Type.ActualType == TypeVal.Number) {
            ...
            n.Type.ActualType = TypeVal.Error;
            throw new TypeException(n, $"Type mismatch, expected array index to be of type {TypeVal.Number}, actual type is {n.Index.Type}");
        }
    ...
    public void Visit(AssNode n) { // Add constant check, needs to be in ST (i think)
        ...
        if (n.Id.Type.ActualType == n.Expr.Type.ActualType) {
            ...
            n.Type.ActualType = TypeVal.Error;
            throw new TypeException(n, n.Id.Type.ActualType, n.Expr.Type.ActualType);
        }
    }
    ...
    public void Visit(PlusNode n) {
        ...
        if (n.Left.Type.ActualType == TypeVal.Number && n.Right.Type.ActualType == TypeVal.Number)
        {
            ...
            n.Type.ActualType = TypeVal.Error;
            throw new TypeException(n, TypeVal.Number, TypeVal.String, n.Left.Type.ActualType, n.Right.Type.ActualType);
        }
    }
    ...
    public void Visit(UMinusNode n) {
        ...
        if (n.Left.Type.ActualType == TypeVal.Number) {
            ...
            n.Type.ActualType = TypeVal.Error;
            throw new TypeException(n, $"Type mismatch, expected value to be of type {TypeVal.Number}, actual type is {n.Left.Type.ActualType}");
        }
    }
    ...
    public void Visit(WhileNode n) {
        ...
        if (n.Condition.Type.ActualType == TypeVal.Boolean) {
            ...
            n.Type.ActualType = TypeVal.Error;
            throw new TypeException(n, $"Type mismatch, expected condition to be of type {TypeVal.Boolean}, actual type is {n.Condition.Type.ActualType}");
        }
    ...
    public void Visit(ForNode n) {
        ...
        if (n.Initializer.Type.ActualType == TypeVal.Number && n.Limit.Type.ActualType == TypeVal.Number && n.Update.Type.ActualType == TypeVal.Number) { // If it's a literal, it's number.. If it's varDcl, it's Ok??? 
            ...
            n.Type.ActualType = TypeVal.Error;
            throw new TypeException(n, $"Type mismatch, expected for-parameters to be of types (Number, Number, Number), actual types are ({n.Initializer.Type.ActualType}, {n.Limit.Type.ActualType}, {n.Update.Type.ActualType})");
        }
        _symbolTable.CloseScope();
    }
    ...
    public void Visit(FuncExprNode n) {
        ...
        foreach (var param in n.Params) {
            ...
            if (param.Type != parameterTypes[i] || param.Type.ActualType == TypeVal.Error) {
                n.Type.ActualType = TypeVal.Error;
                throw new TypeException(n, $"Type mismatch, expected parameter {i} to be of type {parameterTypes[i]}, actual type is {param.Type.ActualType}");
            }
            i++;
        }
    }
    ...
    public void Visit(RetNode n) {
        if (n.SurroundingFuncType.ActualType == TypeVal.Blank) {
            ...
            if (n.SurroundingFuncType == n.RetVal.Type) {
                ...
                n.Type.ActualType = TypeVal.Error;
                throw new TypeException(n,$"Type mismatch, expected return value to be of type {n.SurroundingFuncType}, actual type is {n.RetVal.Type}");
            }
        }
    }
    ...
    public void Visit(IfNode n) {
        ...
        if (n.Condition.Type == expectedType) {
            ...
            n.Type.ActualType = TypeVal.Error;
            throw new TypeException(n, $"Type mismatch, expected condition to be of type {TypeVal.Boolean}, actual type is {n.Condition.Type}");
        }
        _symbolTable.OpenScope();
    ...
    public void Visit(ElseIfNode n)
    {
        ...
        {
            n.Type.ActualType = TypeVal.Error;
            throw new TypeException(n, TypeVal.Boolean, n.Condition.Type.ActualType);
        }
        n.Type.ActualType = TypeVal.Ok;
        _symbolTable.OpenScope();
